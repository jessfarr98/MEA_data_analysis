function MEA_GUI_Preview_Data(num_well_rows, num_well_cols, num_electrode_rows, num_electrode_cols, RawData)
    ...
    main_pan = uipanel(preview_wells_fig, 'Position', [0 0 screen_width screen_height]);
    ...
    for w_r = 1:num_well_rows
        for w_c = 1:num_well_cols
            ...
            view_button = uibutton(sub_p, 'push','Text', 'View Data', 'Position',[2 15 ((screen_width-200)/num_well_cols)-10 (screen_height/num_well_rows)-19], 'ButtonPushedFcn', @(view_button,event) viewWellPushed(view_button, wellID, w_r, w_c, screen_width, screen_height, num_electrode_rows, num_electrode_cols));
