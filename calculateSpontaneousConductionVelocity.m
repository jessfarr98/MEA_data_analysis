function [conduction_velocity, model] =  calculateSpontaneousConductionVelocity(well_ID, electrode_data,  num_electrode_rows, num_electrode_cols, conduction_velocity)
