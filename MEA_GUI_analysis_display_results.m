function MEA_GUI_analysis_display_results(AllDataRaw, num_well_rows, num_well_cols, beat_to_beat, analyse_all_b2b, stable_ave_analysis, spon_paced, well_electrode_data, Stims, added_wells, bipolar, save_dir)
    ...
    function wellButtonPushed(well_button, added_wells, well_count, num_electrode_rows, num_electrode_cols, beat_to_beat, stable_ave_analysis, bipolar, spon_paced, out_fig)
        ...
        function heatMapButtonPushed(heat_map_button, well_elec_fig, well_ID, num_electrode_rows, num_electrode_cols, spon_paced)
            ...
            conduction_map_GUI3(start_activation_times, num_electrode_rows, num_electrode_cols, spon_paced, well_elec_fig)
        end
    ...
    function saveB2BButtonPushed(save_button, electrode_data, save_dir, well_ID, num_electrode_rows, num_electrode_cols, save_plots)
        %%disp('save b2b')
        %%disp(save_dir)
    ...
    function saveB2BPlotsButtonPushed(save_button, electrode_data, save_dir, well_ID, num_electrode_rows, num_electrode_cols)
        %%disp('save b2b')
        %%disp(save_dir)
        disp(strcat('Saving Data for', {' '}, well_ID))
    ...
    function saveAveTimeRegionPushed(save_button, electrode_data, save_dir, well_ID, num_electrode_rows, num_electrode_cols, save_plots)
        %%disp('save b2b')
        %%disp(save_dir)
        %%disp(well_ID)
        disp(strcat('Saving Data for', {' '}, well_ID))
    ...
    function saveAveTimeRegionPlotsPushed(save_button, electrode_data, save_dir, well_ID, num_electrode_rows, num_electrode_cols)
        %%disp('save b2b')
        %%disp(save_dir)
        %%disp(well_ID)
    ...
    function saveAllB2BButtonPushed(save_button, save_dir, num_electrode_rows, num_electrode_cols, save_plots)
        ...
        for w = 1:num_wells
            ...
            saveB2BButtonPushed(save_button, electrode_data, save_dir, well_ID, num_electrode_rows, num_electrode_cols, save_plots);
    ...
    function saveAllTimeRegionButtonPushed(save_button, save_dir, num_electrode_rows, num_electrode_cols, save_plots)
        ...
        for w = 1:num_wells
            well_ID = added_wells(w);
            electrode_data = well_electrode_data(w).electrode_data;
            saveAveTimeRegionPushed(save_button, electrode_data, save_dir, well_ID, num_electrode_rows, num_electrode_cols, save_plots)
