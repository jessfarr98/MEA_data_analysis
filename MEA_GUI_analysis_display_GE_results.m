    ...
    function saveGEPushed(save_button, ge_results_fig, save_dir, num_electrode_rows, num_electrode_cols, dropdown_array)
        ...
        for w = 1:num_wells
            ...
            elseif strcmp(spon_paced, 'paced')
                ...
                electrode_stats_table = table('Size', [1, 16], 'VariableTypes', ["string", "double",  "double",  "double",  "double",  "double",  "double",  "double",  "double",  "double",  "double",  "double",  "double", "string", "string", "string"], 'VariableNames', cellstr([electrode_data(min_electrode_beat_stdev_indx).electrode_id, 'Activation Time (s)', 'Depolarisation Spike Amplitude (V)', 'Depolarisation slope', 'T-wave peak Time (s)', 'T-wave peak (V)', 'FPD (s)', 'Beat Period (s)', 'Stable Beats Duration (s)', 'Stim-spike hold-off (s)', 'Post-spike hold-off (s)', 'T-wave Duration Input (s)', 'T-wave offset Input (s)', 'T-wave Shape', 'Filter Intensity', 'Warnings']));
                ...
                electrode_stats_table(:, 10) = stim_spike_hold_off_array;
                electrode_stats_table(:, 11) = post_spike_hold_off_array;
                electrode_stats_table(:, 12) = t_wave_duration_array;
                electrode_stats_table(:, 13) = t_wave_offset_array;
                electrode_stats_table(:, 14) = t_wave_shape_array;
                electrode_stats_table(:, 15) = filter_intensity_array;
                electrode_stats_table(:, 16) = warning_array;
            ...
            elseif strcmp(spon_paced, 'paced bdt')
                ...
                electrode_stats_table = table('Size', [1, 19], 'VariableTypes', ["string", "double",  "double",  "double", "double",  "double",  "double",  "double",  "double",  "double",  "double",  "double",  "double",  "double",  "double",  "double", "string", "string", "string"], 'VariableNames', cellstr([well_electrode_data(well_count).electrode_data(electrode_count).electrode_id, 'Activation Time (s)', 'Depolarisation Spike Amplitude (V)', 'Depolarisation slope', 'Stable Beats Duration (s)', 'FPD (s)', 'Beat Period (s)', 'Time Region Start (s)', 'Time Region End (s)', 'Beat Detection Threshold Input (V)', 'Mininum Beat Period Input (s)', 'Maximum Beat Period Input (s)', 'Stim-spike hold-off (s)', 'Post-spike hold-off (s)', 'T-wave Duration Input (s)', 'T-wave offset Input (s)', 'T-wave Shape', 'Filter Intensity', 'Warnings']));
                ...
                electrode_stats_table(:, 13) = stim_spike_hold_off_array;
