function [added_wells] = MEA_GUI_select_wells(num_well_rows, num_well_cols)
    ...
    for w_r = 1:num_well_rows
        for w_c = 1:num_well_cols
            ...
            add_button = uibutton(sub_p, 'push', 'BackgroundColor','#e68e8e', 'Text', 'Add 2 Analysis', 'Position',[2 15 ((screen_width-200)/num_well_cols)-10 (screen_height/num_well_rows)-19], 'ButtonPushedFcn', @(add_button,event) addWellPushed(add_button, wellID));
