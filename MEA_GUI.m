...
%  Create and then hide the UI as it is being constructed.
   ...
   function runButtonPushed(run_button, RawData, RawFileData, Stims, b2b_options_dropdown, stable_options_dropdown, b2bdropdown, paced_spon_options_dropdown, start_fig, bipolarDropdown, plate_well_options_dropdown, cross_talk_options_dropdown, save_dir)
      %disp('worked')
      ...
      if cross_talk_options_dropdown.Value == 2
          ...
          prompt_cross_talk_minimisation_wells(RawData, added_wells, beat_to_beat, spon_paced, analyse_all_b2b, stable_ave_analysis, bipolar, save_dir, get(plots_input_ui, 'Value'))
      else
   ...
   function runFastButtonPushed(run_fast_button, RawData,RawFileData, Stims, b2b_options_dropdown, stable_options_dropdown, b2bdropdown, paced_spon_options_dropdown, start_fig, bipolarDropdown, plate_well_options_dropdown, cross_talk_options_dropdown, save_dir)
      %disp('worked')
      %disp(b2bdropdown.Value);
      %disp(stable_options_dropdown.Value);
      %disp(b2b_options_dropdown.Value);
