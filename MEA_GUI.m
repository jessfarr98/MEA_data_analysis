...
%  Create and then hide the UI as it is being constructed.
   ...
   function runButtonPushed(run_button, RawData,RawFileData, Stims, b2b_options_dropdown, stable_options_dropdown, b2bdropdown, paced_spon_options_dropdown, start_fig, bipolarDropdown, plate_well_options_dropdown, save_dir)
      ...
      if plate_well_options_dropdown.Value == 1
          MEA_BDT_GUI_V2(RawData,Stims, beat_to_beat, spon_paced, analyse_all_b2b, stable_ave_analysis, added_wells, bipolar, fullfile(save_dir, get(plots_input_ui, 'Value')))
      
      else
          MEA_BDT_PLATE_GUI_V2(RawData,Stims, beat_to_beat, spon_paced, analyse_all_b2b, stable_ave_analysis, added_wells, bipolar, fullfile(save_dir, get(plots_input_ui, 'Value')))
   ...
   function runFastButtonPushed(run_fast_button, RawData,RawFileData, Stims, b2b_options_dropdown, stable_options_dropdown, b2bdropdown, paced_spon_options_dropdown, start_fig, bipolarDropdown, plate_well_options_dropdown, save_dir)
      ...
      if plate_well_options_dropdown.Value == 1
          MEA_GUI_FAST_THRESHOLD_INPUTS(RawData, start_fig, Stims, beat_to_beat, spon_paced, analyse_all_b2b, stable_ave_analysis, added_wells, bipolar, fullfile(save_dir, get(plots_input_ui, 'Value')))
